	...
	<div class="row">
		...
		<%
                   if(user3 !=null)
                   {
                	   ...
                	   com.DAO.PostDAO ob=  new com.DAO.PostDAO();
                   ...
                   <b class="text-success">Published Date: <%=po.getPdate() %></b></br>
                      <b class="text-success"></b>
                   	...
                   	<div class="container text-center mt-2">
                   	   <a href="DeleteServlet?note_id=<%=po.getId() %>" class="btn btn-danger"><i class="fa-solid fa-trash-can-arrow-up"></i>Delete</a>
                       
                        <a href="edit.jsp?note_id=<%=po.getId() %>" class="btn btn-primary"><i class="fa-regular fa-pen-to-square" aria-hidden="true"></i>Edit</a>
